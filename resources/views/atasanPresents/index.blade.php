                ...
                <div class="row">
                    <div class="col-lg-12 mb-1">
                        ...
                        <form class="form-inline" action="{{ route('atasanPresents.search') }}" method="get">
                            ...
                            <input type="text" class="form-control mb-2 mr-sm-2 col-lg-3" placeholder="Nama Pegawai "
                                id="nama_pegawai" placeholder="" name="nama_pegawai"
                                ...
                                @foreach ($presents as $present)
                                    <tr>
                                        ...
                                        @if ($present->keterangan != 'Alpha' && $present->keterangan != 'Libur')
                                            ...
                                            <td><a href="{{ route('atasanPresents.edit', $present) }}"
                                                    class="btn btn-sm btn-info" title="Tinjau Absen"><i
