                                ...
                                <div class="form-row form-inline">
                                    <div class="col-md-7">
                                        <div class="form-group mb-1">
                                            <label for="fileExcel"
                                                class="col-form-label s-12 col-md-4"><strong>Nama</strong></label>
                                            <input type="text" value="{{ $user->nama }}" disabled
                                                class="form-control r-0 light s-12 col-md-7" autocomplete="off" required />

                                        </div>
                                        <div class="form-group m-0">
                                            <label for="fileExcel" class="col-form-label s-12 col-md-4"><strong>File
                                                    Excel</strong></label>
                                            <input type="file" name="fileExcel" id="fileExcel"
                                                aria-describedby="fileExcelHelp" placeholder=""
                                                class="form-control r-0 light s-12 col-md-7" autocomplete="off" required />
                                            <small id="fileExcelHelp" class="form-text text-muted offset-md-4">Unduh <a
                                                    href="{{ asset('file/example-presensi.xlsx') }}"
                                                    title="Unduh template excel">template excel</a>.</small>
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                    ...
                                    <div class="card-body offset-md-3">
                                        <button type="submit" class="btn btn-primary btn-sm" id="action5"><i
                                                class="icon-save mr-2"></i>Unggah</button>
                                    </div>
                                </div>
                            </form>
                ...
                $.ajax({
                    ...
                    error: function(data) {
                        ...
                        $('#alert5').html(
                            ...
                            message + "<ol class='pl-3 m-0'>" + err + "</ol></div>");
                    }
                });
                return false;
            }
